...
parent: none
children: none
synced: 2026-08-17T03:00:23.990Z
---
...
The following updates have all been created. To force a retry/rebase of any, click on a checkbox below.
 ...
 - [ ] <!-- rebase-branch=renovate/npm-dev-dependencies -->[build(npm): update npm dev dependencies](../pull/181) (`@typescript-eslint/eslint-plugin`, `@typescript-eslint/parser`, `@vercel/ncc`, `globals`, `tsx`, `typescript-eslint`)
 - [ ] <!-- rebase-branch=renovate/lock-file-maintenance -->[build(npm): lock file maintenance](../pull/182)
...
<details><summary>.github/workflows/dist-check.yml (4)</summary>
...
<details><summary>.github/workflows/integration-test.yml (18)</summary>
...
<details><summary>.github/workflows/js-quality.yml (4)</summary>
...
<details><summary>.github/workflows/release-extension.yml (7)</summary>
...
<details><summary>.github/workflows/sync-main-to-dev.yml</summary>
...
<details><summary>package.json (17)</summary>
 ...
 - `@vercel/ncc ^0.44.0` → [Updates: `^0.45.0`]
 - `eslint ^10.1.0`
